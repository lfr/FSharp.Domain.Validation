...
|ꜰᴀʙʟᴇ|👉 For Fable projects only reference the package & namespace [FSharp.ValidationBlocks.Fable](https://www.nuget.org/packages/FSharp.ValidationBlocks.Fable/)|
:---: | :---
